            ...
            <div class="bg-white shadow-lg rounded-lg p-8">
                <form action="{{ route('order-items.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" id="quantity" name="quantity" class="w-full px-4 py-2 border-2 border-blue-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition" value="{{ old('quantity', 1) }}" placeholder="1" required>
                        @error('quantity')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
