            ...
            <div class="bg-white shadow-lg rounded-lg p-8">
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="name" name="name" class="w-full px-4 py-2 border-2 border-blue-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition" value="{{ old('name') }}" placeholder="Nama kategori" required>
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" name="description" rows="4" class="w-full px-4 py-2 border-2 border-blue-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition" placeholder="Deskripsi kategori">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
